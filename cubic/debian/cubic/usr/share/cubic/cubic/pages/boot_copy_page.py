...
def setup(action, old_page=None):
    ...
    if action == 'copy-boot':
        ...
        displayer.update_status('boot_copy_page__progress', BLANK)
...
def copy_files(current_directory, uris):
    ...
    displayer.update_status('boot_copy_page__progress', PROCESSING)
    ...
    try:
        ...
        displayer.update_status('boot_copy_page__progress', ERROR)
    ...
    displayer.update_status('boot_copy_page__progress', OK)
...
def copy_file(file_path, file_number, directory, total_files):
    ...
    def progress_callback(percent):
        ...
        displayer.update_list_store_progress_bar_percent('boot_copy_page__file_details__list_store', file_number, percent)
